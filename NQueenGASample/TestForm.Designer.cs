...
partial class TestForm
{
	...
	private void InitializeComponent()
	{
		...
		// numTournamentSize
		// 
		numTournamentSize.Location = new Point(135, 155);
		...
		numGenerationGap.Location = new Point(135, 184);
		...
		numMutationProbability.Location = new Point(135, 115);
		...
		numMutationProbability.Value = new decimal(new int[] { 5, 0, 0, 131072 });
		// 
		// label4
		// 
		...
		// numIndividualCnt
		// 
		numIndividualCnt.Location = new Point(135, 51);
		numIndividualCnt.Maximum = new decimal(new int[] { 1000000, 0, 0, 0 });
		...
		// numGenerationCnt
		// 
		numGenerationCnt.Location = new Point(135, 80);
		numGenerationCnt.Maximum = new decimal(new int[] { 1000000, 0, 0, 0 });
