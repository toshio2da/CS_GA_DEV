namespace GALib.Core.Models
{
	...
	{
		protected AbstractIndividualModel(int genoSize)
		{
			GenoSize = genoSize;
		}
		...
		public Individual CreateNewIndividual() => new Individual(this, CreateNewGene());

		public Individual CreateNewIndividual(IGene gene) => new Individual(this, gene);

		public Individual CreateNewIndividual(object[] baseData) => new Individual(this, CreateNewGene(baseData));
		...
		public Individual CreateNewIndividual(ITypedGene<TBase> gene) => new Individual(this, CreateNewGene(gene));

		public Individual CreateNewIndividual(TBase[] baseData) => new Individual(this, CreateNewGene(baseData));
