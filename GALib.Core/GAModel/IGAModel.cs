...
namespace GALib.Core.GAModel
{
	...
	public interface IGAModel
	{
		...
		/// </remarks>
		/// 
		public ISelection? SelectionAlgorithm { get; }
		...
		/// </remarks>
		public ISurvive? SurviveAlgorithm { get; }
		...
		/// </remarks>
		public ICrossover? CrossoverAlgorithm { get; }


		public IMutation? MutationAlgorithm { get; }
		public IInverse? InverseAlgorithm { get; }
	}
}