...
public class GASearchContext
{
	...
	{
		if (this.superior.Count <= 0) return null;

		double maxFitnessValue = this.superior.Max(e => e.FitnessValue);

		return this.superior.FirstOrDefault(e => e.FitnessValue == maxFitnessValue);
	}
